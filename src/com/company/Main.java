...
public class Main {
    ...
    public static void main(String[] args) {
            ...
            album=new Album("For those obout the rock","AC/DC");
            album.addSong("For those obout the rock",5.44);
                ...
                switch (action){
                    ...
                    case 2:
                        ...
                        if(listIterator.hasPrevious()){
                            ...
                            System.out.println("We are at the star of the playList.");
                            forward=true;
                        }
                        break;
                    case 3:
                        if(forward){
                            if(listIterator.hasPrevious()){
                                ...
                                System.out.println("We are at the star of the list.");
                            }
                        }else{
                            if(listIterator.hasNext()){
